...
```
<br>
length * arrangement interaction:
```{r}
...
There was a significant two-way interaction between number of unique items and whether items were moved (b = -20.06, 95% CI [-37.80, -2.31], t = 2.21, p = .03). Hoever, followup comparisons did not yield significant predictors (all p > .11)
